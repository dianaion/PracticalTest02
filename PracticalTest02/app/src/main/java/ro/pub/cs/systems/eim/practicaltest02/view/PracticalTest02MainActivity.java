...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private EditText badUrlEditText = null;
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            HashSet<String> addresses = serverThread.getData();
            if (!addresses.contains(clientAddress)) {
                clientThread = new ClientThread(
                        clientAddress, Integer.parseInt(clientPort), weatherForecastTextView
                );
                clientThread.start();
            }
        }
    ...
    private class AddButtonClickListener implements Button.OnClickListener {
        ...
        @Override
        public void onClick(View view) {
            String url = badUrlEditText.getText().toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        badUrlEditText = (EditText)findViewById(R.id.bad_url_edit_text);
        addButton = (Button)findViewById(R.id.add_button);
        addButton.setOnClickListener(addButtonClickListener);
        clientAddressEditText = (EditText)findViewById(R.id.client_address_edit_text);

        getWeatherForecastButton = (Button)findViewById(R.id.go_button);
